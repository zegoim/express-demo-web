...
function enableAiDenoise() {
  isAidenoise = !isAidenoise;
  $("#enableAiDenoise").text(`${isAidenoise?"close":"open"}`)
  localStream &&
      zg.enableAiDenoise(localStream, isAidenoise).catch(err=>console.error(err));
}
