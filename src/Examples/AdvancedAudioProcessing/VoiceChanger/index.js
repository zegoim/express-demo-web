...
$("#setVoiceChanger").click(setVoiceChanger)
function setVoiceChanger() {
  const preset = $("#voicePreset").val();
  localStream &&
      zg.setVoiceChangerPreset(parseInt(preset), localStream).catch(err=>console.error(err));
}
