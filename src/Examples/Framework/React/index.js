class CommonUsageReact extends React.Component {
    ...
    async loginRoomOption(){
        try {
            ...
            await this.loginRoom(this.state.roomID, this.state.userID, this.state.userID);
        } catch (err) {
            this.setState({
                isLogin: false
            })
        ...
        return <div className="row">
                <div className="col-12 col-lg-6 preview-wrapper">
                    <div className="preview-roomInfo">
                        RoomID:&nbsp;<div id="roomInfo-id" className="m-r-10"></div>
                ...
                <div className="col-12 col-lg-6 action-wrapper">
                    ...
                    <div className="action-step">
                        ...
                        <div className="action-room font-14">
                            <div className="action-roomId f-b-3">
                            RoomID <input type="text" id="RoomID" name="roomID" value={this.state.roomID} onChange={this.changeValue.bind(this)} disabled={this.state.isLogin} />
                            </div>
                            <div className="action-userName f-b-7">
                            UserName <input type="text" className="w-70" id="UserName" name="userID" value={this.state.userID} onChange={this.changeValue.bind(this)} disabled={this.state.isLogin} />
                            </div>
                        </div>
